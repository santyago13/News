const Footerr = () => {
  return (
    <nav className="footer footer-horizontal mt-20 footer-center bg-sky-450 text-primary-content p-10">
      <aside>
        {/* Logo personalizado */}
        <svg
          className="w-12 h-12 text-gray-800 dark:text-white inline-block mb-2"
          aria-hidden="true"
        ...
        <p className="font-bold">
          Santiago Robledo.
          <br />
          Desarrollador web y aficionado a la programación
        </p>
        <p>
